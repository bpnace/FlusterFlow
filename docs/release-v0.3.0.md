...
## Lokale RC-Verifikation am 5. September 2026

| Prüfung | Ergebnis |
| --- | --- |
| Capped-Testplan | PASS, 176 von maximal 180 Tests ausgewählt |
| Capped App-Tests | PASS, 176 Tests, 0 Fehler |
| SwiftPM-Tests | PASS, 363 Tests, 14 erwartete opt-in Smokes übersprungen, 0 Fehler |
| Unsigned Xcode-Build | PASS |
| Netzwerk-Boundary | PASS |
| Target-Harness | PASS, 28 Szenarien |
| Local-Privacy-Harness | PASS, 0 Leaks, Pasteboard unverändert |
| Signing-Prerequisite | Erwarteter Exitcode 77 mit `identity_required`; kein signiertes Artefakt erzeugt |

Diese lokale Verifikation ersetzt weder die GitHub-CI noch die manuellen Prüfungen auf dem Ziel-Mac.
...
- Lokal signierten Release-Build zweimal mit `Scripts/verify-private-signing.sh` prüfen und anschließend Mikrofon-/Accessibility-TCC-Kontinuität testen.
