...
- echte Mikrofonwahl und eine auf 120 Sekunden begrenzte Aufnahme im Arbeitsspeicher;
...
Die Standardeinstellung ist vollständig lokal. Nach einmaliger Modellbereitstellung benötigt der Diktatpfad kein Netzwerk, kein Konto und keine laufenden Kosten. Es gibt keine Diktathistorie, keine Telemetrie und keine automatische Nutzung der allgemeinen Zwischenablage.
...
5. Sprache, Mikrofon und Push-to-talk-Kürzel auswählen. Standard ist `⌃⌥Leertaste`.
...
Den Cursor in ein editierbares Textfeld setzen, das ausgewählte Kürzel gedrückt halten, sprechen und loslassen. FlusterFlow erkennt, bereinigt und überarbeitet den Text automatisch und erfasst direkt vor der Einfügung das dann aktuell fokussierte Textfeld samt Auswahl oder Cursorposition neu. Der fertige Text ersetzt die Auswahl beziehungsweise erscheint an der Einfügemarke; es gibt keinen Clipboard-, Ergebnisfenster- oder Bestätigungsschritt. Secure Fields und Nicht-Textfelder werden nicht beschrieben.
